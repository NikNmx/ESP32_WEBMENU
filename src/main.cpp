...
#define WIFI_SSID "IoTT"
#define WIFI_PASS "1111qQ1111qQ,@,@"
...
void build(sets::Builder& b) {
    {
        ...
        b.Slider(kk::slider);
        b.Select(kk::sel, "select1", "foo;bar;test");
        if (b.Button(kk::btn, "Save Settings Custom", 0x0000FF)) Serial.println("btn 0");
        }
    //} 
    {
        ...
        if (b.Button()) {
            ...
            Serial.println(F("12345"));
            Serial.println(db[kk::pass]);
            sett.setPass((db[kk::pass]));
                        };
    }
