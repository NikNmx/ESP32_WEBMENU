        ...
        <div class="container">
         ...
         <div class="divider"></div>
            ...
            <div class="divider">
                ...
                <input type="checkbox" id="inverse_input1"  name="inverse_input1" />
                <label class="check-box" for="inverse_input1">Інверсія входу 1:</label>
            </div>
            <div class="divider">
                <input type="checkbox" id="scales" name="scales"  />
        <label class="check-box" for="scales">Scales(reset db)</label>
            </div>
            <div class="divider"></div>
            <div class="form-group">
    ...
    function getData() {
        fetch('/get_data')
            ...
            .then(data => {
                ...
                if (data.scales === "false")  {
                    document.getElementById('scales').checked = false;
                    } else {
                    document.getElementById('scales').checked = true;    
                };
                if (data.inverse_input1 === "false") {
                    document.getElementById('inverse_input1').checked = false; 
                    } else {
                        document.getElementById('inverse_input1').checked = true;
                };
